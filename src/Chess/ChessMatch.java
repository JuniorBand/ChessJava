...
public class ChessMatch {
    ...
    private void initialSetup(){
        ...
        board.placePiece(new Pawn(board,Color.BLACK), new Position(0,7));
        ...
        board.placePiece(new Rook(board,Color.BLACK), new Position(1,5));
        board.placePiece(new Rook(board,Color.BLACK), new Position(1,6));
        ...
        board.placePiece(new Pawn(board,Color.WHITE), new Position(7,7));
        ...
        board.placePiece(new Rook(board,Color.WHITE), new Position(6,4));
